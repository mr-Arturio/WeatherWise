...
export default function Navbar({ location }: Props) {
  ...
  return (
    <>
      <nav className="shadow-sm sticky top-0 left-0 z-50 bg-blue-200">
        <div className="h-[90px] w-full flex justify-between items-center max-w-screen-2xl px-3 mx-auto">
          <p className="flex items-center justify-center gap-2">
            <h2 className="text-blue-500 text-3xl font-bold">WeatherWise</h2>
